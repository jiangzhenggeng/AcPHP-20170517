...
class xUpLoad {
	...
	// 设置限制上传文件的类型
	private $allowtype = array ('gif','jpg','jpeg','png','bmp','swf','flv','swf','flv','mp3','wav','wma','wmv','mid','avi','mpg','asf','rm','rmvb','doc','docx','xls','xlsx','ppt','htm','html','txt','zip','rar','gz','bz2');
